...
no API key, no cost. LangGraph orchestrates the chat graph itself, but
still uses LangChain's document loader / text splitter / vector store
integrations underneath, which is the standard way LangGraph RAG apps
are built.
